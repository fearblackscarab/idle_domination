    ...
    const mizunoeUpgrade = () => {
        ...
        if (rank.currency.souls >= rank.mizunoe.cost) {
            ...
            rank = {
                ...rank,
                currency: {
                    souls: rank.currency.souls - rank.mizunoe.cost
                }
            };

            if (rank.mizunoe.cost <= 50) {

                rank = {
                    ...rank,
                    mizunoe: {
                        ...rank.mizunoe,
                        cost: rank.mizunoe.cost * 2
                    }
                };
                    ...
                    <div className="row">
                        ...
                        <div className="currency-div col-4" id="currenctDiv">
                            <div className="row">
                                ...
                                <div className="col-6">
                                    <div className="row">
                                        <div className="coin-container col-12">
                                            <div className="souls">
                                                Souls:{data.currency.souls}
